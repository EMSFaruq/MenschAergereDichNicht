    ...
    void create(int ID, ImageIcon icon, String PosX, String PosY) { 
        ...
        label[ID] = new JLabel();
            ...
            if(frame.isUndecorated()) {
                ...
                icon = new ImageIcon(icon.getImage().getScaledInstance(icon.getIconWidth() * frame.getWidth() / 1920 - 16, icon.getIconHeight() * frame.getHeight() / 1080 - 39, Image.SCALE_DEFAULT));
