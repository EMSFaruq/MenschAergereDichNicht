        ...
        for (int i = 1; i <= 4 ; i++) {
            ...
            if(i == 1) {
                ...
                if(frame.isUndecorated()) {
                    ...
                    img = new ImageIcon(img.getImage().getScaledInstance(img.getIconWidth() - 16 * frame.getWidth() - 16 / 1920 - 16, img.getIconHeight() - 16 * frame.getHeight() - 16 / 1080 - 16, Image.SCALE_DEFAULT));
